    ...
    <div className="card w-full max-w-sm shadow-xl bg-base-100 p-8 rounded-2xl">
      ...
      <form onSubmit={handleSubmit(handleRegister)}>
        <fieldset className="fieldset">
          ...
          <input type="text" {...register('firsName',{required:true, maxLength:15})} className="input" placeholder="Name"  />
          {
        ...
        <p>Already have an account?please <Link className="text-blue-600 underline"
